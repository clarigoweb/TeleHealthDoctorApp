...
import com.app.telehealthdoctor.ui.adaptors.AvailabilityAdaptor
import com.app.telehealthdoctor.ui.adaptors.AvailabilityDaysAdaptor
...
class AvailabilityFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view: View = inflater.inflate(R.layout.fragment_availability, container, false)
        setUpdaysListAdaptor(view)
        setUpdAvailabilityAdaptor(view)
    ...
    private fun setUpdAvailabilityAdaptor(view: View) {
        view.rv_availabilityList.layoutManager = LinearLayoutManager(activity)
        view.rv_availabilityList.adapter = AvailabilityAdaptor()
    }

...
import com.app.telehealthdoctor.ui.adaptors.AppointmentAdaptor
...
class AppointmentFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        setUpAppointmentadaptor(view)
        return view
    }

    private fun setUpAppointmentadaptor(view: View) {
        view.rv_appintment.layoutManager = LinearLayoutManager(activity)
        view.rv_appintment.adapter = activity?.let { AppointmentAdaptor(it) }
    }
